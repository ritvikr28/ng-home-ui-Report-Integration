...
describe('Sims7RedirectionsSidePanel.helpers', () => {
  ...
  it('onValidateDateHandler calls handleValidateDate', () => {
    const mock = jest.fn();
    helpers.onValidateDateHandler({ date: '2026-03-09', setDateError: jest.fn(), handleValidateDate: mock });
    expect(mock).toHaveBeenCalledWith('2026-03-09', expect.any(Function));
  });
