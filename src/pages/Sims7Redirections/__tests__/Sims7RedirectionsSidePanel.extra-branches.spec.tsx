...
describe("Sims7RedirectionsSidePanel extra branch coverage", () => {
  ...
  it("clears effectiveDate in PUT payload for Reversing→Migrated and Planned→NotMigrated transitions", () => {
    ...
    const payload1 = buildRequest({ status: 'Migrated', plannedStatus: 'Migrated', reasonForChanges: 'Test', id: '1', dfeNumber: 'd', nextGenModule: 'n', ngModule: 'n', category: 'c', switchToSchool: false }, '2026-04-09', 'Reversing');
    ...
    expect(payload2.effectiveDate).toBe("");
    // No transition
    const payload3 = buildRequest({ status: 'Migrated', plannedStatus: 'Migrated', reasonForChanges: 'Test', id: '1', dfeNumber: 'd', nextGenModule: 'n', ngModule: 'n', category: 'c', switchToSchool: false }, '2026-04-09', 'Migrated');
