...
const NoAccessView: (props: INoAccessProps) => JSX.Element = (
  props: INoAccessProps
) => {
  const { IsAuthzAdmin }: INoAccessProps = props;
    ...
    <div id="no-access-page">
      {IsAuthzAdmin ? (
        <>
          ...
          >
            <ErrorActionList
              description={t("noAccessForAuthzAdmin.moduleBlock.heading")}
            >
              <ErrorActionListItem
        ...
        <div id="no-access-wrapper" data-testid="no-access-non-admin">
          <Grid align="flex-start" dataTestId="NoAccessPageTestId">
            <GridItem sm={12}>
              ...
              <div className="module-block">
                ...
                <div className="list-item">
                  ...
                  <div className="item-content">
                    ...
                    <a
                      href="https://customer.support-ess.com/csm"
                      target="blank"
                    >
