...
const QuickLink: ({}: IQuickLinkViewProps) => JSX.Element = ({
  ...
  const filteredQuickLinkData =
    apiQuickLinkData?.filter(
      (link) => link.name !== t("quickLink.classview")
    ) || [];
    ...
    <>
      <div className="quicklink-main-container">
        <div className="quicklink-breadcrumb">
          {!isOpen && (
            <div className="quicklink-openclose-btn">
              <Button
        ...
        <div className="quicklink-table">
          <>
            <div className="quicklinks-heading">
              {t("quickLink.headingTitle")}
            </div>
            <div className="quicklinks-subheading">
              {" "}
          ...
          <>
            ...
            <div className="new-margin-b-container-sims">
