...
jest.mock("../../../shared/services/quickLinkDomain/quickLinkService", () => ({
...
describe("SidePanel Component", () => {
  ...
  test("renders sidepanel component with empty data and star icon", async () => {
    ...
    jest
      ...
      .mockReturnValueOnce(Promise.resolve(axiosResponse));
    ...
    expect(qicklink.FetchQuickLinkpost).toHaveBeenCalled();
    waitFor(() => {
      expect(linkDetails.fetchQuickLinkDetails).not.toHaveBeenCalled();
  ...
  test("renders sidepanel component with mock data and star icon error for api", async () => {
    ...
    jest
      .spyOn(qicklink, "FetchQuickLinkpost")
      .mockReturnValueOnce(Promise.reject(axiosResponse));
    ...
    const quicklinkDataWithClassView = [
      {
        id: 1,
        name: "Class View",
        link: "https://dev.home.sims.co.uk/seatingplans/classview",
        favourite: false,
        createdOn: "2025-02-12T12:25:53.843"
      },
      {
        id: 2,
        name: "Link 1",
