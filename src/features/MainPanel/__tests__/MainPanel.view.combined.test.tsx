...
describe('MainPanelView useEffect video play status', () => {
  ...
  it.skip('sets isPlayed true and apiError false when result.success and isPlayed is "true"', async () => {
  ...
  it.skip('sets isPlayed false and apiError true when result.success is false', async () => {
