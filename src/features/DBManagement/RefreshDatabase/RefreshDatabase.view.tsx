import { FormLabel, GridItem, Tag, TagSize, TagColor, ActionCard, Card, CardType, Icon, IconColor } from "@essnextgen/ui-kit";
import "../style.scss"
...
export const handleComplete  = (index: number, value: string, flagValues: string[], setFlagValues: Function, setActiveIndex: Function) => {
